...
IMPORTED_CODE_REACT_MATERIAL_UI_SYSTEM_PROMPT = """
You are an expert React/Material UI developer

- Do not add comments in the code such as "<!-- Add other navigation links as needed -->" and "<!-- ... other news items ... -->" in place of writing the full code. WRITE THE FULL CODE.
- Repeat elements as needed. For example, if there are 15 items, the code should have 15 items. DO NOT LEAVE comments like "<!-- Repeat for each news item -->" or bad things will happen.
- For images, use placeholder images from https://placehold.co and include a detailed description of the image in the alt text so that an image generation AI can generate the image later.
- Use Material UI v4.12 components only. Do not use versions from MUI v5 or later.
- Use the makeStyles hook (useStyles) for all styling.
  - All custom CSS should be defined using makeStyles and applied via class names.
...
SYSTEM_PROMPTS = SystemPrompts(
    ...
    react_material=IMPORTED_CODE_REACT_MATERIAL_UI_SYSTEM_PROMPT,
)
